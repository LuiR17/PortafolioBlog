            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
                <div class="mx-auto max-w-[1200px] flex flex-col gap-6">
                    ...
                    <div class="flex items-center flex-wrap gap-2 text-sm">
                        ...
                        <span class="text-[#56566c]">/</span>
                        <span class="text-white font-medium">Edit Blog Post</span>
                    </div>
                    <!-- Main Grid -->
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full">
                        ...
                        <div class="lg:col-span-8 flex flex-col gap-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $blogPost->title) }}"
                                class="w-full bg-[#151520] border border-[#3b3b54] rounded-lg text-white text-sm px-3 py-2.5 focus:border-primary focus:ring-1 focus:ring-primary outline-none placeholder:text-[#56566c]"
                            ...
                            <textarea name="excerpt" id="excerpt" rows="3"
                                class="w-full bg-[#151520] border border-[#3b3b54] rounded-lg text-white text-sm px-3 py-2.5 focus:border-primary focus:ring-1 focus:ring-primary outline-none placeholder:text-[#56566c]"
                                placeholder="Un breve resumen de tu publicación">{{ old('excerpt', $blogPost->excerpt) }}</textarea>
                            ...
                            <input type="file" name="preview_image" id="preview_image" accept="image/*"
                                class="w-full bg-[#151520] border border-[#3b3b54] rounded-lg text-white text-sm px-3 py-2.5 focus:border-primary focus:ring-1 focus:ring-primary outline-none file:bg-[#282839] file:border-0 file:rounded file:px-3 file:py-1 file:text-white file:mr-2">
                        ...
                        <div class="lg:col-span-4 flex flex-col gap-6">
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <select name="visibility"
                                            class="w-full bg-[#151520] border border-[#3b3b54] rounded-lg text-white text-sm px-3 py-2.5 focus:border-primary focus:ring-1 focus:ring-primary outline-none">
                                            <option value="public" {{ old('visibility', $blogPost->visibility) == 'public' ? 'selected' : '' }}>Public</option>
                                            <option value="private" {{ old('visibility', $blogPost->visibility) == 'private' ? 'selected' : '' }}>Private</option>
                                        </select>
                                    </div>
                                    <div class="flex flex-col gap-1">
                                        <label class="text-[#9d9db9] text-sm">Publish Date</label>
                                        <input name="published_at"
                                            class="w-full bg-[#151520] border border-[#3b3b54] rounded-lg text-white text-sm px-3 py-2.5 focus:border-primary focus:ring-1 focus:ring-primary outline-none [color-scheme:dark]"
                                            type="datetime-local" value="{{ old('published_at', $blogPost->published_at ? \Carbon\Carbon::parse($blogPost->published_at)->format('Y-m-d\TH:i') : '') }}" />
                                    </div>
                                </div>
                            </div>
                            <!-- URL Slug -->
                            <div class="bg-surface-dark rounded-xl border border-[#282839] p-5 shadow-sm">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div
                                        class="flex items-center bg-[#151520] border border-[#3b3b54] rounded-lg overflow-hidden focus-within:border-primary focus-within:ring-1 focus-within:ring-primary">
                                        ...
                                        <input name="slug"
                                            ...
                                            type="text" value="{{ old('slug', $blogPost->slug) }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
