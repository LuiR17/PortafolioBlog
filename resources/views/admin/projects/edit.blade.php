                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-6">
                        ...
                        <div class="bg-[#1c1c27] rounded-xl border border-[#282839] p-6 flex flex-col gap-6">
                            ...
                            <label class="flex flex-col gap-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="A brief summary for the project card..." rows="3" name="short_description">{{ old('short_description', $project->short_description) }}</textarea>
                            ...
                            <label class="flex flex-col gap-2">
                                ...
                                <input
                                    class="w-full rounded-lg border border-[#3b3b54] bg-[#111118] text-white placeholder-[#9d9db9] focus:border-primary focus:ring-1 focus:ring-primary p-3 text-base"
                                    placeholder="e.g. Acme Corporation" name="client_name" value="{{ old('client_name', $project->client_name) }}" />
                            </label>
                            <!-- Role Input -->
                            <label class="flex flex-col gap-2">
                                ...
                                <input
                                    class="w-full rounded-lg border border-[#3b3b54] bg-[#111118] text-white placeholder-[#9d9db9] focus:border-primary focus:ring-1 focus:ring-primary p-3 text-base"
                                    placeholder="e.g. Lead Developer" name="role" value="{{ old('role', $project->role) }}" />
                            </label>
                            <!-- Platform Input -->
                            <label class="flex flex-col gap-2">
                                ...
                                <input
                                    class="w-full rounded-lg border border-[#3b3b54] bg-[#111118] text-white placeholder-[#9d9db9] focus:border-primary focus:ring-1 focus:ring-primary p-3 text-base"
                                    placeholder="e.g. Web, Mobile, Desktop" name="platform" value="{{ old('platform', $project->platform) }}" />
                            </label>
                            <!-- Full Description -->
                            <label class="flex flex-col gap-2">
                                ...
                                <textarea
                                    class="w-full rounded-lg border border-[#3b3b54] bg-[#111118] text-white placeholder-[#9d9db9] focus:border-primary focus:ring-1 focus:ring-primary p-3 text-base resize-none"
                                    placeholder="A detailed description of the project..." rows="6" name="full_description">{{ old('full_description', $project->full_description) }}</textarea>
                            </label>
                            <!-- Problem Solved -->
                            <label class="flex flex-col gap-2">
                                ...
                                <textarea
                                    class="w-full rounded-lg border border-[#3b3b54] bg-[#111118] text-white placeholder-[#9d9db9] focus:border-primary focus:ring-1 focus:ring-primary p-3 text-base resize-none"
                                    placeholder="What problem did this project solve?" rows="3" name="problem_solved">{{ old('problem_solved', $project->problem_solved) }}</textarea>
                            </label>
                            <!-- Status Select -->
                            <label class="flex flex-col gap-2">
                        ...
                        <div
                            ...
                            <x-forms.tinymce-edit :content="old('content', $project->content)" />
                        </div>
                            ...
                            <label class="flex flex-col gap-2">
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        type="date" name="development_time" value="{{ old('development_time', $project->development_time ? \Carbon\Carbon::parse($project->development_time)->format('Y-m-d') : '') }}" />
                                </div>
                            </label>
                            <!-- Links -->
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="Live Demo URL" name="demo_url" value="{{ old('demo_url', $project->demo_url) }}" />
                                </div>
                                <div class="flex items-center gap-2">
                                    <div class="bg-[#282839] p-2 rounded-lg text-white">
                                    ...
                                    <input
                                        class="flex-1 rounded-lg border border-[#3b3b54] bg-[#111118] text-white placeholder-[#9d9db9] focus:border-primary focus:ring-1 focus:ring-primary p-2 text-sm"
                                        placeholder="GitHub Repo URL" name="repository_url" value="{{ old('repository_url', $project->repository_url) }}" />
                                </div>
                            </div>
                        </div>
                    </div>
