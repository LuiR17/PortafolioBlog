...
<body class="bg-background-light dark:bg-background-dark min-h-screen flex flex-col overflow-x-hidden">
    ...
    <!-- Footer -->
    <footer class="border-t border-gray-200 dark:border-border-dark bg-white dark:bg-surface-dark">
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="flex items-center gap-2 text-gray-900 dark:text-white">
                    ...
                    <span class="font-bold text-sm">DevPortfolio</span>
                </div>
                <div class="text-gray-500 dark:text-gray-400 text-sm">
                    © 2024 DevPortfolio. All rights reserved.
                </div>
                <div class="flex gap-4">
                    <a class="text-gray-500 dark:text-gray-400 hover:text-primary transition-colors" href="#">
